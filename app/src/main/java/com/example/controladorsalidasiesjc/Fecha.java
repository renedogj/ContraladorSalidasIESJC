...
public class Fecha {
     ...
     *
     * @param dia
     *        int que equivale al dia que se va a comprobar si existe o no
     *
     ...
     *
     * @param mes
     *        int que equivale al mes que se va a comprobar si existe o no
     *
     ...
     *
     * @param año
     *        int que equivale al año que se va a comprobar si existe o no
     ...
     *
     * @param hora
     *        int que equivale a la hora que se va a comprobar si existe o no
     ...
     *
     * @param fecha1
     *        parámetro tipo fecha que hace referencia a la primera fecha de entre las cuales
     *        se quiere conocer la diferencia de fecha.
     * @param fecha2
     *        parámetro tipo fecha que hace referencia a la segunda fecha de entre las cuales
